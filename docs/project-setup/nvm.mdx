...
Our current stack relies heavily on a Javascript runtime named [Node](https://nodejs.org/en/about). You can think of it as the most important *dependency* of the project. 
...
At this point, you might notice typing `nvm use` every time you open a new terminal can be a bit annoying (and you will probably forget most of the times). NVM's maintainer [offers an integration](https://github.com/nvm-sh/nvm?tab=readme-ov-file#deeper-shell-integration) to deal with that:
