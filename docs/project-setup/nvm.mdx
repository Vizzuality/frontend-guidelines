...
Note: this approach does **not replace the `.nvmrc` file**. This is just a way to have a default Node version in case you are in a directory without a `.nvmrc` file.
